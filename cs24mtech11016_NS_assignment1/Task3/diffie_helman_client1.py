...
def generate_private_key():
    return random.randint(1, p - 1)         # to choose random number between 1 to p-1 as private key for this client

# Generate public key based on private key
def generate_public_key(private_key):
    return pow(g, private_key, p)           # calculating A to share with other client

# Compute shared secret
def compute_shared_secret(public_key, private_key):
    return pow(public_key, private_key, p)              # calculating  same shared key 
